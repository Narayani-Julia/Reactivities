...
public class DbInitializer
{
    ...
    // {
    //     //Check if there are any activities in the db
    //     if (context.Activities.Any()) return;

    //     //Make sure the Activity is from Domain
    ...
    //     //tracking this inside memory, entity framework is tracking this in memory
